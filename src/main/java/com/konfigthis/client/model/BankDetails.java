...
import com.konfigthis.client.model.BankType;
...
public class BankDetails {
  ...
  **/
  ...
  public BankDetails type(BankType type) {
  ...
  **/
   ...
   * @return the BankDetails instance itself
   */
  public BankDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, bankDetails.name) &&
        Objects.equals(this.type, bankDetails.type)&&
        Objects.equals(this.additionalProperties, bankDetails.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankDetails is not found in the empty JSON string", BankDetails.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BankDetails>() {
           ...
           public BankDetails read(JsonReader in) throws IOException {
             ...
             BankDetails instance = thisAdapter.fromJsonTree(jsonObj);
