...
public class CreateTransferRequest {
  ...
  private Object originatingAccount;
  ...
  public CreateTransferRequest description(String description) {
  ...
  **/
  ...
  public CreateTransferRequest counterparty(Object counterparty) {
  ...
  **/
  ...
  public CreateTransferRequest amount(Money amount) {
  ...
  **/
  ...
  public CreateTransferRequest externalMemo(String externalMemo) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "External memo for the transfer. `Payment Instructions` for Wires and the `Entry Description` for ACH payments.  Must be at most 90 characters for `ACH` and `WIRE` transactions and at most 40 characters for `CHEQUES` ")
  ...
  public CreateTransferRequest originatingAccount(Object originatingAccount) {
  ...
  **/
  ...
  public CreateTransferRequest approvalType(ApprovalType approvalType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createTransferRequest.description) &&
        Objects.equals(this.counterparty, createTransferRequest.counterparty) &&
        Objects.equals(this.amount, createTransferRequest.amount) &&
        Objects.equals(this.externalMemo, createTransferRequest.externalMemo) &&
        Objects.equals(this.originatingAccount, createTransferRequest.originatingAccount) &&
        Objects.equals(this.approvalType, createTransferRequest.approvalType)&&
        Objects.equals(this.additionalProperties, createTransferRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, counterparty, amount, externalMemo, originatingAccount, approvalType, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("external_memo");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateTransferRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("external_memo").isJsonPrimitive()) {
      ...
      // validate the required field `originating_account`
      Object.validateJsonObject(jsonObj.getAsJsonObject("originating_account"));
      // validate the optional field `approval_type`
      if (jsonObj.get("approval_type") != null && !jsonObj.get("approval_type").isJsonNull()) {
        ApprovalType.validateJsonObject(jsonObj.getAsJsonObject("approval_type"));
      }
  }
